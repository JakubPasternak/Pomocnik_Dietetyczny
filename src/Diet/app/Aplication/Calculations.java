...
public class Calculations extends DietFrame {
    ...
    public static double KCALResult(String gender, double age, double weight, double height, double CMP) {
        double result = 0.0;
        if ("kobieta".equals(gender)) {
            result =  (655.1 + (9.563 * weight) + (1.85 * height) - (4.676 * age)) * CMP;
        } else if ("mężczyzna".equals(gender)) {
            result =  (66.473 + (13.752 * weight) + (5.003 * height) - (6.775 * age)) * CMP;
        }
